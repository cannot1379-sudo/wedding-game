...
import { onAuthStateChanged, signInWithPopup, OAuthProvider, signOut } from 'firebase/auth';
...
export function useAuth() {
  ...
  const login = async (name) => {
    try {
      ...
      const newUser = { id: firebaseUser.uid, name: firebaseUser.displayName || name || 'Guest' };
